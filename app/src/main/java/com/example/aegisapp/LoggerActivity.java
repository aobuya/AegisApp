...
public class LoggerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LoggerActivity.this, ResetPassword.class));
            }
        });
    ...
    private void logIn() {
        ...
        firebaseAuth.signInWithEmailAndPassword(email_user, pass_user)
                .addOnCompleteListener(LoggerActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            if (password.length() < 6) {
                                ...
                                Toast.makeText(LoggerActivity.this, getString(R.string.auth_failed), Toast.LENGTH_LONG).show();
                            }
                            ...
                            if (user.isEmailVerified()){
                                progressBar.setVisibility(View.GONE);
                                Intent intent = new Intent(LoggerActivity.this, MainActivity.class);
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            progressBar.setVisibility(View.GONE);
                                                            Toast.makeText(LoggerActivity.this, "Email sent", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                    }
